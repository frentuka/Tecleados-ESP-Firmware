...
*   **For High-Level Overviews & Architecture:** ONLY read the files in the `universe/modules/` directory (start at `file:///home/srleg/Projects/Tecleados-ESP-Firmware/universe/Home.md`). Use these to understand how modules relate and depend on each other before proposing architectural changes.
