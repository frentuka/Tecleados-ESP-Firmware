/**
 * @file hid.h
 * @brief TinyUSB HID keycode shim for host testing.
 *
 * Provides the HID_KEY_* and HID_USAGE_CONSUMER_* constants used by
 * kb_layout.h without pulling in the full TinyUSB stack.
 */
#pragma once

/* Standard HID keycodes (USB HID Usage Tables, Keyboard/Keypad page 0x07) */
...
#define HID_KEY_MENU               HID_KEY_APPLICATION

/* Consumer control usage codes (USB HID Usage Tables, Consumer page 0x0C) */
